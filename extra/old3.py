...
3. For items with multiple prices (e.g., "180/190" or "Veg/Paneer 180/190"):
   - Create separate entries for each variant
   - Example: "Malai Momos Veg/Paneer 180/190" becomes two items:
     {"name": "Malai Momos Veg", "price": 180}
     {"name": "Malai Momos Paneer", "price": 190}
4. For items with size columns (Medium/Large/Ex Large):
   - Create separate entries for each size
   - Example: "Mango Shake" with prices 100/110/120 becomes:
     {"name": "Mango Shake Medium", "price": 100}
     {"name": "Mango Shake Large", "price": 110}
     {"name": "Mango Shake Ex Large", "price": 120}
5. Prices must be numbers only (no strings).
